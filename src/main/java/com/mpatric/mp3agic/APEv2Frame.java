...
public class APEv2Frame {
	...
	public APEv2Frame(byte[] buffer, int offset) throws InvalidDataException {
		unpackFrame(buffer, offset);
	}

	public APEv2Frame(String id, byte[] data) {
		this.id = id;
		this.data = data;
	...
	public boolean equals(Object obj) {
		if (! (obj instanceof APEv2Frame)) return false;
		if (super.equals(obj)) return true;
		APEv2Frame other = (APEv2Frame) obj;
